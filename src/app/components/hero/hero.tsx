      ...
      <div className="container-section relative z-10">
        <div className="grid grid-cols-2 gap-5 mt-20">
          <div className="flex flex-col justify-center h-full flex-1 ">
            ...
            <h1 className="text-[2rem] font-bold text-zinc-800 mt-2">
            ...
            <div className="flex items-center gap-8 mt-8">
              <button className="flex items-center gap-2 bg-[#374282] px-12 py-3 text-white rounded-md cursor-pointer hover:brightness-125 transition-all duration-300 ">
